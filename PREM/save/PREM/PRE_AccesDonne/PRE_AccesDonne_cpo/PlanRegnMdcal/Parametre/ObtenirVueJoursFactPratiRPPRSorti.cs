...
namespace RAMQ.PRE.PRE_AccesDonne_cpo.PlanRegnMdcal.Parametre
{
    ...
    ///  Date   : Février 2017
    /// </remarks>
	public class ObtenirVueJoursFactPratiRPPRSorti : ParamSorti
    {
        /// <summary>
        /// Constructeur
        /// </summary>
        /// <remarks></remarks>
        public ObtenirVueJoursFactPratiRPPRSorti()
        {
            ListeJoursFactParRPPR = new List<JoursFactParRPPR>();
        }
        ...
        /// </summary>
        /// <remarks></remarks>
        public IEnumerable<JoursFactParRPPR> ListeJoursFactParRPPR { get; set; }
    }
}