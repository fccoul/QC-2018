...
namespace RAMQ.PRE.PL_LogiqueAffaire_cpo.GenerationPDF.GenerationXmlGabarit.Gabarits.ConfirmationAvisConformite
{
    ...
    ///  la page de confirmation d'une avis de conformité
    /// </summary>
    /// <remarks>
    ///  Auteur : Alexis Garon-Michaud <br/>
    ///  Date   : Mars 2017
    /// </remarks>
    public class ConfirmationAvisConformiteXmlBuilder : IXmlBuilder
    {
        ...
        public ConfirmationAvisConformiteXmlBuilder(ISerialiseurXml serialiseurXml)
        {
        ...
        /// Gabarit
        /// </summary>
        public GabaritConfirmationAvisConformite Gabarit { get; } = new GabaritConfirmationAvisConformite();

        /// <summary>
        /// Nombre de priorité requis
        /// </summary>
        public static readonly byte NombrePrioriteRequis  = 5;
